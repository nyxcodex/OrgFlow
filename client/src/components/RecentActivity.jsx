...
const statusColors = {
    ...
    DONE: "border-teal-300 text-teal-700 dark:border-teal-700 dark:text-teal-300",
};
...
const RecentActivity = () => {
    ...
    return (
        <div className="app-panel hover:border-violet-200 dark:hover:border-violet-500/30 rounded-xl transition-all overflow-hidden">
                ...
                {tasks.length === 0 ? (
                    ...
                    <div className="relative divide-y divide-zinc-200 dark:divide-zinc-800">
                        {tasks.map((task) => {
                            ...
                            return (
                                <div key={task.id} className="p-5 hover:bg-violet-50/50 dark:hover:bg-[#24212d] transition-colors">
                                    <div className="flex items-start gap-4">
                                        ...
                                        <div className="flex-1 min-w-0">
                                            <div className="flex items-start justify-between mb-2">
                                                ...
                                                <span className={`app-tag ml-2 ${statusColors[task.status] || "border-zinc-300 text-zinc-600 dark:border-zinc-600 dark:text-zinc-300"}`}>
